...
/**
 * This class is used to represent the token ListDeclaration found in the AST
 */
public class ListDeclaration extends TreeNode {
    ...
    /**
     * This method will call the methode corresponding to a list declaration depending on the visitor
     * @param v the visitor
     */
    @Override
